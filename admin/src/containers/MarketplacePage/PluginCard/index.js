...
import { Button, PopUpWarning, CheckPermissions } from 'siapi-helper-plugin';
        ...
        <div className="wrapper">
          <div className="cardTitle">
            ...
            <div
              onClick={e => {
                window.open(
                  `https://github.com/siapi/siapi/tree/master/packages/siapi-plugin-${this.props.plugin.id}`,
                  '_blank'
                );
              }}
            >
