...
import { BaselineAlignment, useGlobalContext, request } from 'siapi-helper-plugin';
...
const EditPage = () => {
      ...
      : [
          {
            ...
            disabled: role.code === 'siapi-super-admin',
            onClick: () => {
              handleReset();
  ...
  const handleEditRoleSubmit = async data => {
    try {
      ...
      if (role.code !== 'siapi-super-admin') {
  ...
  const isFormDisabled = role.code === 'siapi-super-admin';
