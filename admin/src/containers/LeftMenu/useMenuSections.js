...
import { useUser } from 'siapi-helper-plugin';
...
const useMenuSections = (plugins, shouldUpdateSiapi) => {
  ...
  const shouldUpdateSiapiRef = useRef(shouldUpdateSiapi);
