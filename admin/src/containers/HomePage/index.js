...
import { auth, LoadingIndicatorPage } from 'siapi-helper-plugin';
...
const FIRST_BLOCK_LINKS = [
  {
    link:
      'https://siapi.io/documentation/developer-docs/latest/getting-started/quick-start.html#_4-create-a-category-content-type',
    contentId: 'app.components.BlockLink.documentation.content',
    titleId: 'app.components.BlockLink.documentation',
  },
  {
    link: 'https://github.com/siapi/foodadvisor',
...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/siapi/siapi/',
  },
  {
    name: 'Slack',
    link: 'https://slack.siapi.io/',
  }
];
              ...
              <FormattedMessage id="HomePage.roadmap">
                {msg => (
                  <ALink
                    ...
                    href="https://portal.productboard.com/siapi/1-public-roadmap/tabs/2-under-consideration"
                    target="_blank"
                  >
                    {msg}
                  </ALink>
